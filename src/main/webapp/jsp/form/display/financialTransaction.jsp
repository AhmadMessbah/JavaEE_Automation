...
<div class="formbold-main-wrapper">
    <div class="formbold-form-wrapper">
        ...
        <div class="formbold-form-title">
            <a class="formbold-btn warning" href="#" onclick="showEditFinancialTransaction(${sessionScope.financialTransaction.id})">ویرایش</a>
            <a class="formbold-btn danger" href="#" onclick="removeFinancialTransaction(${sessionScope.financialTransaction.id})">حذف</a>
        </div>

        <!--start form-->
        <form id="bank-display" inert>
            <div class="formbold-input-flex">
                <input class="form-control" type="text" name="id" value="${sessionScope.financialTransaction.id}" hidden="hidden">
            ...
            <div class="formbold-input-flex">
                ...
                <div>
                    ...
                    <input id="bankAmount" class="formbold-form-input" value="${sessionScope.financialTransaction.bankAmount}" type="text" name="bankAmount">
                </div>
            </div>
            ...
            <div class="formbold-input-flex">
                ...
                <div>
                    ...
                    <input id="cashAmount" class="formbold-form-input" value="${sessionScope.financialTransaction.cashAmount}" type="text" name="cashAmount">
                </div>
            </div>
            ...
            <div class="formbold-input-flex">
                <div>
                    ...
                    <input id="trackingCode" class="formbold-form-input" value="${sessionScope.financialTransaction.trackingCode}" type="text" name="trackingCode">
                </div>
            ...
            <div class="formbold-input-flex">
                <div>
                    ...
                    <input type="text" name="date" id="date" placeholder="تاریخ  را وارد کنید"  value="${sessionScope.financialTransaction.faDate}" class="formbold-form-input">
                </div>
            </div>
